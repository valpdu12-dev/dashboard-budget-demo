...
const ROWS: Row[] = [
  ...
  { date: "2026-02-03", label: "Boulangerie", compte: "Bourso", montant: -8 },
  { date: "2026-03-21", label: "Abonnement", compte: "CE", montant: -15 },
];
...
describe("DataTable — colonnes prioritaires en mode carte", () => {
  ...
  it("révèle la colonne non prioritaire au clic sur « Détails », par carte", () => {
    ...
    expect(screen.queryByText("Bourso")).toBeNull();
  });
