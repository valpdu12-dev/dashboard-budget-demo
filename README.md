...
> **Démonstration publique. Tous les montants sont inventés.**
> La structure des comptes reprend une configuration réelle, sous des noms
> génériques (Banque A, Banque B…). Tout le reste — montants, dates, libellés, marchands, villes,
> employeurs, salaires, prêt — est inventé par un générateur à graine fixe :
> [`scripts/generate-demo-data.mjs`](scripts/generate-demo-data.mjs), qui ne
> lit aucun fichier.
...
**Le paramétrage se corrige dans le fichier, pas à l'écran.** Depuis le lot C,
comptes, types, taux de participation, comptes liés, couleurs et prêt viennent
