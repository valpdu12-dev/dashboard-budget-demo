...
//
// L'EXEMPTION, nommée par la décision D5 :
//
...
//
// La seconde — `src/services/modeleExcel.ts`, les données d'exemple du
// classeur modèle — a disparu avec ce fichier au lot F.5 (F9). Le modèle est
// désormais fabriqué par `scripts/generer-modele.mjs`, hors de `src/`.
//
